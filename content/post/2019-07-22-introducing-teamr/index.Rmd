...
messages to Microsoft Teams, [`teamr`](https://github.com/wwwjk366/teamr).
...
I found that we will have the same needs for communicating with R as well. So with some inspiration from the Python package [`pymsteams`](https://pypi.org/project/pymsteams/).
...
You probablity noticed now that this package is built using `R6` class(very nice tutorial by Hadley [here](https://adv-r.hadley.nz/r6.html)).
...
If you want to learn more regarding Microsoft Connectors, you check out the offical doc [here](https://docs.microsoft.com/en-us/microsoftteams/platform/concepts/connectors/connectors-using).

## Summary

This is my very first package on CRAN so if you found any bugs please report here [https://github.com/wwwjk366/teamr/issues](https://github.com/wwwjk366/teamr/issues).
